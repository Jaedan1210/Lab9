...
public class LinScan1 {
    public static void main(String[] args) {
        ...
        // Initialize each element in the array with a random value that is between 1 and 100
        ...
        int userValue = SafeInput.getRangedInt(scanner, "Please enter a value that is between 1 and 100", 1, 100);
